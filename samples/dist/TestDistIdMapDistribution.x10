...
public class TestDistIdMapDistribution {
...
//    val home = PlaceGroup(0): PlaceGroup;
	...
	val team = new x10.util.Team(pg);
        new TestDistIdMapDistribution(pg, team).run();
    }
...
//		Console.OUT.println("" + here + " moves key: " + key + " to " + d);
	...
	val distSnapshot1 = distIdMap.getDistributionLong();
	...
	val distSnapshot2 = distIdMap.getDistributionLong();
	...
	val distSnapshot3 = distIdMap.getDistributionLong();
	...
	val distSnapshot5 = distIdMap.getDistributionLong();
	...
	// Move using distSnapshot1

	// Distribute all entries with additional key/value
        Console.OUT.println("");
        Console.OUT.println("### Distribute all entries using distSnapshot1");
        Place.places().broadcastFlat(() => {
	    val mm = new MoveManagerLocal(placeGroup, team);
	    distIdMap.moveAtSync(distSnapshot1, mm);
            mm.sync();
        });
	...
	// Move using distSnapshot2

	// Distribute all entries with additional key/value
        Console.OUT.println("");
        Console.OUT.println("### Distribute all entries using distSnapshot2");
        Place.places().broadcastFlat(() => {
	    val mm = new MoveManagerLocal(placeGroup, team);
	    distIdMap.moveAtSync(distSnapshot2, mm);
            mm.sync();
        });
	...
	// Move using distSnapshot3

	// Distribute all entries with additional key/value
        Console.OUT.println("");
        Console.OUT.println("### Distribute all entries using distSnapshot3");
        Place.places().broadcastFlat(() => {
	    val mm = new MoveManagerLocal(placeGroup, team);
	    distIdMap.moveAtSync(distSnapshot3, mm);
            mm.sync();
        });
	...
	// Move using distSnapshot5

	// Distribute all entries with additional key/value
        Console.OUT.println("");
        Console.OUT.println("### Distribute all entries using distSnapshot5");
        Place.places().broadcastFlat(() => {
	    val mm = new MoveManagerLocal(placeGroup, team);
	    distIdMap.moveAtSync(distSnapshot5, mm);
            mm.sync();
        });
